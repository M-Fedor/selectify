...
into the readfish's ru_gen script.
...
from basecall import Mapper as CustomMapper
from basecall import GuppyCaller as Caller
...
from utils import DecisionTracker
...
def simple_analysis(
    ...
    if dry_run:
        ...
        decision_dict = {
            "stop_receiving": lambda c, n: stop_receiving_action_list.append((c, n)),
            "proceed": None,
            "unblock": lambda c, n: unblock_batch_action_list.append((c, n)),
        }
    decision_str = ""
